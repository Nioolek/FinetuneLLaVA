...
CUDA_VISIBLE_DEVICES=0 NCCL_IB_DISABLE=1 NCCL_P2P_DISABLE=1 deepspeed finetune.py \
    ...
    --version v1 \
    --data_path /root/autodl-tmp/data/logo0821_crop/json/train_0821_update.json,/root/autodl-tmp/data/logo0821_crop/json/train_none.json,/root/autodl-tmp/data/logo0821_crop/json/train_0821_desc.json,/root/autodl-tmp/data/logo0821_crop/json/fewshot.json \
