...
SAVENAME=baseline6_lorar1_nodesc
...
CUDA_VISIBLE_DEVICES=0,1,2,3 NCCL_IB_DISABLE=1 NCCL_P2P_DISABLE=1 deepspeed finetune.py \
    ...
    --version v1 \
    --data_path /root/autodl-tmp/data/logo0821_crop/json/train_0821_update.json,/root/autodl-tmp/data/logo0821_crop/json/train_none.json \
